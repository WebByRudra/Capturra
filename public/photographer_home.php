        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <!-- Messages -->
                    <div class="relative cursor-pointer" onclick="openMessages()">
                        <span class="text-2xl hover:scale-110 transition-transform">💬</span>
                        <div class="absolute -top-1 -right-1 w-3 h-3 bg-blue-500 rounded-full notification-dot"></div>
                    </div>
...
<?php if(mysqli_num_rows($result) > 0): ?>
    ...
    <?php
        ...
        $initial_comments = array_slice($comments_array, -3); // last 3 comments
        $hidden_comments = array_slice($comments_array, 0, -3);
        ...
        if(file_exists($image_path)){
            ...
            $width = 16;  // default to 16:9 landscape
            $height = 9;
        }
    ?>
