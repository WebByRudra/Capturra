...
<head>
    ...
    <title>Capturra - Events Photography</title>
...
<section style="background:radial-gradient(ellipse at 50% 0%,#1a0a2e 0%,#0f0f13 60%);padding:36px 24px 24px;text-align:center;">
    ...
    <h1 style="font-size:30px;font-weight:700;color:#fff;margin:0 0 6px;">Events Photography</h1>
    <p style="color:#6b6b8a;font-size:13px;margin:0 0 16px;"><?php echo $total; ?> photos · Corporate, cultural, and live event photography</p>
    <div style="display:flex;flex-wrap:wrap;justify-content:center;gap:8px;">
        ...
        <a href="events.php" class="cat-pill active">🎭 Events</a>
    </div>
</section>
...
<div style="max-width:1200px;margin:0 auto;padding:24px 24px 60px;display:grid;grid-template-columns:1fr 260px;gap:24px;">
    <div>
        ...
        <div style="text-align:center;padding:60px 20px;">
            ...
            <h3 style="color:#fff;font-size:16px;margin-bottom:6px;">No Events photos yet</h3>
            <p style="color:#6b6b8a;font-size:13px;">Be the first to upload a Events photo!</p>
    ...
    <div style="display:flex;flex-direction:column;gap:14px;">
        <div class="cap-card">
            <h3 style="font-size:13px;font-weight:600;color:#fff;margin:0 0 14px;padding-bottom:10px;border-bottom:1px solid #2a2a3e;">📸 Top Events Photographers</h3>
        ...
        <div class="cap-card">
            <h3 style="font-size:13px;font-weight:600;color:#fff;margin:0 0 12px;padding-bottom:10px;border-bottom:1px solid #2a2a3e;">💡 Events Tips</h3>
            <div style="display:flex;flex-direction:column;gap:8px;">
                <div style="background:#1a0a2e;border:1px solid #3a2060;border-radius:8px;padding:10px;font-size:12px;color:#a0a0c0;">⚡ Use a fast lens (f/1.8+) in low light</div>
                <div style="background:#1a0a2e;border:1px solid #3a2060;border-radius:8px;padding:10px;font-size:12px;color:#a0a0c0;">📷 Shoot burst mode to capture action</div>
                <div style="background:#1a0a2e;border:1px solid #3a2060;border-radius:8px;padding:10px;font-size:12px;color:#a0a0c0;">🎯 Arrive early to scout angles and lighting</div>
                <div style="background:#1a0a2e;border:1px solid #3a2060;border-radius:8px;padding:10px;font-size:12px;color:#a0a0c0;">🔋 Bring extra batteries — events run long</div>
            </div>
        </div>
